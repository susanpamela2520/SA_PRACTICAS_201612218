...
@Component({
        ...
        <mat-card-content>
          ...
          @if (success()) {
            <div class="success-msg">
              <mat-icon>check_circle</mat-icon> ¡Entrega confirmada con foto!
            </div>
          }
        </mat-card-content>
          ...
          @if (!success()) {
            <button mat-raised-button color="primary" class="confirm-btn"
              ...
              @if (loading()) {
                ...
                <ng-container>
                  <mat-icon>check</mat-icon> Confirmar entrega
                </ng-container>
              }
            </button>
          } @else {
  ...
  styles: [`
    ...
    .confirm-btn { width: 100%; height: 46px; display: flex; align-items: center; justify-content: center; gap: 6px; }
  `],
})
